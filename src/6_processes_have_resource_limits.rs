...
fn main() {
    ...
    unsafe {
        libc::setrlimit(libc::RLIMIT_NOFILE, &mut rlimit);
    }
    ...
    unsafe {
        libc::getrlimit(libc::RLIMIT_NPROC, &mut rlimit);
    }
    println!("{}, {}", rlimit.rlim_cur, rlimit.rlim_max);
    ...
    unsafe {
        libc::getrlimit(libc::RLIMIT_FSIZE, &mut rlimit);
    }
    println!("{}, {}", rlimit.rlim_cur, rlimit.rlim_max);
    ...
    unsafe {
        libc::getrlimit(libc::RLIMIT_STACK, &mut rlimit);
    }
    println!("{}, {}", rlimit.rlim_cur, rlimit.rlim_max);
}
